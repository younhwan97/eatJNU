package kr.co.younhwan.eatjnu.domain.use_case.get_place_review_report
...
class GetPlaceReviewReportUseCase @Inject constructor(
    ...
    operator fun invoke(userId: String): Flow<Resource<List<PlaceReviewReport>>> = flow {
        try {
            ...
            val data = repository.getPlaceReviewReport(userId = userId).map { it.toPlaceReviewReport() }
