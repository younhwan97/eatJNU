...
interface EatJnuRepository {
    ...
    suspend fun createPlaceReview(userId: String, placeId: Int, comment: String): Boolean

    suspend fun removePlaceReview(reviewId: String, userId: String, placeId: String): Boolean
