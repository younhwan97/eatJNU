...
interface EatJnuApi {
    ...
    @DELETE("PlaceReview/{reviewId}/{userId}/{placeId}")
    suspend fun removePlaceReview(@Path("reviewId") reviewId: String, @Path("userId") userId: String, @Path("placeId") placeId: String): CommonResponseDto
